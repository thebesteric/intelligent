...
@TableName(ApplicationConstants.Application.Module.OpenApi.TABLE_NAME_PREFIX + "r_role_privilege")
@EntityClass(comment = "角色权限关联表", schemas = ApplicationConstants.Application.Module.OpenApi.DATASOURCE_INTELLIGENT_MODULE_OPEN_API)
